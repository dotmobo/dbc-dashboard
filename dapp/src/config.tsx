...
// Omniscient
export const omniscientUrl1 = 'https://omniscient.tools/partners/DEADBROS-bf822f/analytics';
export const omniscientUrl2 = 'https://omniscient.tools/partners/DAWNBROS-09395f/analytics';
// Esdt market
